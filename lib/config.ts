// URL base de la API
export const API_URL = process.env.NEXT_PUBLIC_API_URL || 'http://147.93.36.93:3000'; //http://api.bayreshub.com
export const API_ENDPOINT = `${API_URL}/api`;

// URL base para el cliente (frontend)
export const CLIENT_URL = process.env.NEXT_PUBLIC_CLIENT_URL || 'http://147.93.36.93:3001';
...
export const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://root:wNbSKJw096Jnz2tSioZdr8wOztNOFNU1i14LTC5zinXzTYJdjSnamupFikv8nPVG@147.93.36.93:3000/bayres-panel?directConnection=true'; 